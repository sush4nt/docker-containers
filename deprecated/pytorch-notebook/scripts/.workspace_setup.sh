...
tmux selectp -t 1
tmux send-keys "sudo jupyter lab --ip 0.0.0.0 --no-browser --allow-root --NotebookApp.token='' --NotebookApp.password=''" C-m

# return to pane 0 and attach session
tmux selectp -t 0
tmux send-keys -l "Hello! Welcome to DSML PyTorch-Lab Container!"
